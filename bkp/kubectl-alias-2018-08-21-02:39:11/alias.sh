...
then
  ...
  echo "alias kdev='/home/vagrant/k-workspace/kubectl-alias/kubectl-alias.sh'" >> ~/.bashrc
  echo "alias set for ${R}kdev ${G}='/home/vagrant/k-workspace/kubectl-alias/kubectl-alias.sh'${NO}"
  echo "alias kubectl-alias='/home/vagrant/k-workspace/kubectl-alias/alias.sh'" >> ~/.bashrc
  echo "alias set for ${R}kubectl-alias ${G}=/home/vagrant/k-workspace/kubectl-alias/alias.sh'${NO}"
